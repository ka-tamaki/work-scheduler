...
def create_gui():
    ...
    # タイトル入力
    tk.Label(root, text="タイトル:", font=("Arial", 14)).grid(row=0, column=0, padx=20, pady=20, sticky='e')
    title_entry = tk.Entry(root, width=40, font=("Arial", 14))
    title_entry.grid(row=0, column=1, padx=20, pady=20)
    
    # 開始年月の選択
    tk.Label(root, text="開始年月:", font=("Arial", 14)).grid(row=1, column=0, padx=20, pady=10, sticky='e')
    ...
    start_year_cb.grid(row=1, column=1, padx=(20,0), pady=10, sticky='w')
    ...
    start_month_cb.grid(row=1, column=1, padx=(80,0), pady=10, sticky='w')
    
    # 終了年月の選択
    tk.Label(root, text="終了年月:", font=("Arial", 14)).grid(row=2, column=0, padx=20, pady=10, sticky='e')
    ...
    end_year_cb.grid(row=2, column=1, padx=(20,0), pady=10, sticky='w')
    
    end_month_cb = ttk.Combobox(root, textvariable=end_month_var, values=months, width=3, state='readonly', font=("Arial", 12))
    end_month_cb.set("07")
    end_month_cb.grid(row=2, column=1, padx=(80,0), pady=10, sticky='w')
    
    # 生成ボタン
    generate_btn = tk.Button(root, text="生成", command=on_generate, width=20, font=("Arial", 14))
    generate_btn.grid(row=3, column=0, columnspan=2, padx=20, pady=30)
